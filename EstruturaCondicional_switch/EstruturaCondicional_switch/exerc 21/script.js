...
switch (media) {
    case 1:
        ...
        let media1 = (primeiraNota1 + segundaNota1) / 2;
        alert(`O seu tipo de média é: Média de 2 notas, as suas notas informadas são ${primeiraNota1} e ${segundaNota1}, a sua média final é ${media1.toFixed(2)}`);
        break;
    case 2:
        ...
        let media2 = (primeiraNota2 + segundaNota2 + terceiraNota2) / 3;
        alert(`O seu tipo de média é: Média de 3 notas, as suas notas informadas são ${primeiraNota2}, ${segundaNota2}, e ${terceiraNota2} a sua média final é ${media2.toFixed(2)}`);
        break;
    case 3:
        ...
        let media3 = (primeiraNota3 + segundaNota3 + terceiraNota3 + quartaNota3) / 4;
        alert(`O seu tipo de média é: Média de 4 notas, as suas notas informadas são ${primeiraNota3}, ${segundaNota3}, ${terceiraNota3} e ${quartaNota3} a sua média final é ${media3.toFixed(2)}`);
        break;
    default:
